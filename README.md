...
<h4 align="center">Guidelines, references, and templates required for the SpaceLab hardware projects.</h4>

<p align="center">
    <a href="https://github.com/spacelab-ufsc/pcb-guidelines/tree/master/pcb_libraries">
		<img src="https://img.shields.io/badge/pcb-libraries-green?style=for-the-badge">
	</a>
    <a href="https://github.com/spacelab-ufsc/pcb-guidelines/tree/master/pcb_projects">
		<img src="https://img.shields.io/badge/pcb-projects-blue?style=for-the-badge">
	</a>
	<a href="https://github.com/spacelab-ufsc/pcb-guidelines/tree/master/pcb_resources">
		<img src="https://img.shields.io/badge/pcb-resources-9cf?style=for-the-badge">
	</a>
	<a href="https://github.com/spacelab-ufsc/pcb-guidelines/tree/master/pcb_templates">
...
## Overview
This guideline aims only to give general and basic directions for the PCB layout for the SpaceLab and does not present complete and extensive standards. This repository is structure as follows:
```
pcb_libraries: Component schematic, footprint, and 3d body libraries.
pcb_projects: Example projects to be used as a start point in new projects.
pcb_resources: Materials, links, design rules, and references.
pcb_templates: Various template sources for the SpaceLab hardware designs.
...
## Templates
- Use the schematics and layout template provided in: Altium and KiCad [templates](https://github.com/spacelab-ufsc/pcb-guidelines/tree/master/pcb_projects).
...
- Remember to  be compliant with the checklist provided in: [Kleber’s checklist](https://github.com/spacelab-ufsc/pcb-guidelines/blob/master/pcb_resources/pcb_design_checklist.xlsx)
...
#### Internal
- Under definition! (Our standards, it can be kleber’s PCB Design Checklist and PC-104 standard)

#### External 
- Standards made by external entities/institutions (Cezar’s simplified guidelines).
